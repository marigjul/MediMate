...
jest.mock('./app/components/ConfirmationModal.tsx', () => {
  ...
  return function MockConfirmationModal({ visible, onConfirm, onCancel, title, message }) {
    if (!visible) return null;
    return React.createElement(View, null,
      React.createElement(Text, { testID: 'modal-title' }, title),
      React.createElement(Text, { testID: 'modal-message' }, message),
      React.createElement(TouchableOpacity, { testID: 'modal-confirm', onPress: onConfirm },
        React.createElement(Text, null, 'Confirm')
      ),
      React.createElement(TouchableOpacity, { testID: 'modal-cancel', onPress: onCancel },
